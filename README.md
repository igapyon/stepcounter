...
igapyon による拡張
----------------
### Visualforce および Apex への対応

ステップカウント対象に Visualforce および Apex の成果物（cls、trigger、pages）を加えるための小さな拡張が加えられています。これがオリジナル Amateras Stepcounter との相違点です。
これに伴い .cls 拡張子の割当が Apex に変更されています。このため、この拡張追加版は VB ソースコードのステップカウント用途には向いていません。
